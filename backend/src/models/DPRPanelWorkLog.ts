...
DPRPanelWorkLog.init(
    {
        ...
        grabbing_start_time: { type: DataTypes.STRING(100), allowNull: true },
        grabbing_end_time: { type: DataTypes.STRING(100), allowNull: true },
        concrete_start_time: { type: DataTypes.STRING(100), allowNull: true },
        concrete_end_time: { type: DataTypes.STRING(100), allowNull: true },
