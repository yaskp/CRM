          ...
          <SectionCard title="Client & Compliance" icon={<BankOutlined />}>
            <Descriptions column={1} bordered size="middle">
              ...
              <Descriptions.Item label={<Text strong>Client GSTIN</Text>}>
                {project.client_gstin ? (
                  <Text copyable>{project.client_gstin}</Text>
                ) : 'N/A'}
              </Descriptions.Item>
                  ...
                  {lead.soil_report_url && (
                    <div style={{
                      ...
                      <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                        ...
                        <div>
                          <Text strong style={{ display: 'block' }}>Soil Report</Text>
                      ...
                      <Button
                        type="link"
                        href={`http://localhost:5000${lead.soil_report_url}`}
                        target="_blank"
                  ...
                  {lead.layout_url && (
                    <div style={{
                      ...
                      <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                        <FileTextOutlined style={{ fontSize: 20, color: theme.colors.primary.main }} />
                        <div>
                          <Text strong style={{ display: 'block' }}>Layout Plan</Text>
                          <Text type="secondary" style={{ fontSize: 12 }}>
                            Lead #{lead.id} • {new Date(lead.created_at).toLocaleDateString()}
                          </Text>
                        </div>
                      ...
                      <Button
                        type="link"
                        href={`http://localhost:5000${lead.layout_url}`}
                        target="_blank"
                        icon={<DownloadOutlined />}
                      />
                    </div>
                  ...
                  {lead.section_url && (
                    <div style={{
                      ...
                      <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                        <FileTextOutlined style={{ fontSize: 20, color: theme.colors.primary.main }} />
                        <div>
                          <Text strong style={{ display: 'block' }}>Section Drawing</Text>
                          <Text type="secondary" style={{ fontSize: 12 }}>
                            Lead #{lead.id} • {new Date(lead.created_at).toLocaleDateString()}
                          </Text>
                        </div>
                      ...
                      <Button
                        type="link"
                        href={`http://localhost:5000${lead.section_url}`}
                        target="_blank"
                        icon={<DownloadOutlined />}
                      />
                    </div>
